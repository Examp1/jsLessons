...
/* harmony import */ var _modules_chengeModalState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/chengeModalState */ "./src/js/modules/chengeModalState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_chengeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
...
/***/ "./src/js/modules/chengeModalState.js":
/*!********************************************!*\
  !*** ./src/js/modules/chengeModalState.js ***!
  \********************************************/
/*! exports provided: default */
...
var chengeModalState = function chengeModalState(state) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              elem.forEach(function (box, j) {
                ...
                box.checked = false; // ставим чекед тому чекбоксу у который совпадает с индексом
...
/* harmony default export */ __webpack_exports__["default"] = (chengeModalState);
...
/* harmony default export */ __webpack_exports__["default"] = (fixOver);
...
var forms = function forms(state) {
  ...
  Object(_checkNumInput__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); // вызываем проверку на цифры модуль checkNumInputs;
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      e.preventDefault(); // создаем элементы чтобы выводить в него текст статуса

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); // делаем формдату и в нее передаем форму которую мы перебираем

      var formDate = new FormData(item); // если у нас есть форма с атрибутом data-calc="end"
      ...
      postDate('./assets/server.php', formDate).then(function (response) {
...
var images = function images() {
  var imgPopup = document.createElement('div'),
      ...
      scroll = Object(_fixOverflow__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _fixOverflow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fixOverflow */ "./src/js/modules/fixOverflow.js");



var modals = function modals() {
  function bindModal(trigerSelector, modalSelector, closeSelectror) {
    ...
    var triger = document.querySelectorAll(trigerSelector),
        ...
        scroll = Object(_fixOverflow__WEBPACK_IMPORTED_MODULE_1__["default"])();
    triger.forEach(function (el) {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // setTimeout(function () {
    ...
    if (target && target.classList.contains(tabSelector.replace(/\./, '')) || target.parentNode.classList.contains(tabSelector.replace(/\./, ''))) {
      tab.forEach(function (tab, i) {
        if (target == tab || target.parentNode == tab) {
          // таргет = элементу который перебирается
          hideTabContent();
          showTabContent(i);
        }
      });
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    var timer = document.querySelector(selector),
        ...
        timreInterval = setInterval(updateClock, 1000); // вызываем апдейт чтобы устранить баг с показыванием статики

    updateClock();

    function updateClock() {
      // в t  записываем сколько нам осталось до дедлайна
      var t = getTimeRemaining(endtime); //в блоки минут секунд итд выведоим их значения 
      // так как мы вернули из getTimeRemaining обьект юзаем его 

      days.textContent = addZero(t.days);
      hours.textContent = addZero(t.hours);
      minutes.textContent = addZero(t.minutes);
      seconds.textContent = addZero(t.seconds); // проверка на дедлайн
